...
public class JsonSerializableCategoryBookTest {
    ...
    private static final Path TEST_DATA_FOLDER = Paths.get("src", "test", "data", "JsonSerializableCategoryBookTest");
...
/*
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        ...
        AddressBook typicalPersonsAddressBook = TypicalBooks.getTypicalLibraryBook();
