...
import static seedu.library.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
import seedu.library.storage.JsonLibraryBookStorage;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonLibraryBookStorage libraryBookStorage =
                new JsonLibraryBookStorage(temporaryFolder.resolve("addressBook.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(libraryBookStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonLibraryBookIoExceptionThrowingStub
        JsonLibraryBookStorage libraryBookStorage =
                new JsonLibraryBookIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
     ...
     */
    private static class JsonLibraryBookIoExceptionThrowingStub extends JsonLibraryBookStorage {
        private JsonLibraryBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }

        @Override
        public void saveLibraryBook(ReadOnlyLibraryBook addressBook, Path filePath) throws IOException {
