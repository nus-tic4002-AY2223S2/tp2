...
public class ParserUtilTest {
    ...
    public void parseAddress_validValueWithoutWhitespace_returnsAddress() throws Exception {
        ...
        assertEquals(expectedCategory, ParserUtil.parseAddress(VALID_ADDRESS));
    }
    ...
    public void parseAddress_validValueWithWhitespace_returnsTrimmedAddress() throws Exception {
        ...
        Category expectedCategory = new Category(VALID_ADDRESS);
        assertEquals(expectedCategory, ParserUtil.parseAddress(addressWithWhitespace));
    }
    ...
    public void parseEmail_validValueWithoutWhitespace_returnsEmail() throws Exception {
        Edition expectedEdition = new Edition(VALID_EMAIL);
        assertEquals(expectedEdition, ParserUtil.parseEmail(VALID_EMAIL));
    }
    ...
    public void parseEmail_validValueWithWhitespace_returnsTrimmedEmail() throws Exception {
        ...
        Edition expectedEdition = new Edition(VALID_EMAIL);
        assertEquals(expectedEdition, ParserUtil.parseEmail(emailWithWhitespace));
    }
